...
class LLM:
    def __init__(
        ...
        self.total_tflops = 6 * self.parameters_b * tokens_t * 1e9
    ...
    def training_co2eq(self):
        ...
        print('total zFlops:', total_FLOPs_all)
        ...
        print('training day number:', training_day_num)
        ...
        print('total energy: ', energyMWh)
        print("training CO2eq:", self.predicted_co2eq_train)
        print("training_delta:", self.train_delta)
    ...
    def inference_co2eq(self):
        ...
        print("predicted inference CO2eq:", self.predicted_co2eq_infer)
